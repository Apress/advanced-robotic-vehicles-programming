...
void loop(void)
{
    ...
    // data elements 1 and 2 are high and low parts of a bigger value 
    // the operator + and |  are interchangeable in this case
    int constru=(_bufferrx[1]<<8) + (_bufferrx[2]);
