...
void loop(void)
{
    ...
    int envi1=2099;
    _buffertx[0]=5;
    _buffertx[1]=envi1>>8;       //high part to send
    _buffertx[2]=envi1 & 0x00FF; // low part to send

// note that the cheksum is only generated with the bits of interest they can be
// all except the same cheksum, or selective as in this case the bits 1 and 2
// because they represent the high and low part of a more relevant data
    _buffertx[3]= _buffertx[1]^_buffertx[2];
    
    hal.uartC->write(_buffertx,4);


// after each writing, the value of the buffers must be reset
    _buffertx[0]=0;
    _buffertx[1]=0;
    _buffertx[2]=0;
    _buffertx[3]=0;
