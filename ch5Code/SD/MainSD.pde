...
static void Save_data(){
    Log_Write_Pose(); // function to save pose data defined in Data.pde
    Log_Write_Control(); // function to save control data defined in Data.pde
    Log_Write_Errors(); // function to save error data defined in Data.pde
}
