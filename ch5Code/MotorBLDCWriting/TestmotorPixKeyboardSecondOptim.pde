...
char readk;
// value to increase or decrease, and to be sent to the selected motors
int incr=0;
// motor label
int mot1,mot2,mo3,mot4;
...
static void readboard(){
    readk= hal.console->read(); 



// q increases from 100 in 100 w of 10 in 10 and e of 1 in 1
// a reduces from 100 in 100 s to 10 in 10 and d to 1 in 1
// it is possible that in some pixhawk models the value to be written to the motor must // be converted in this way hal.rcout-> write (0, uint16_t (incr));
   ...
   if (readk=='q')
    ...
    mot3=incr;
    mot4=incr;
    tomotors (mot1,mot2,mot3,mot4);



}

static void tomotors(int m1, int m2, int m3 int m4){
