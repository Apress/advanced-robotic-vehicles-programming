...
// now just write and update, note that if a pause is not added your motor could be not 
// work or in extreme case it will burn
// HERE is written a sequence to engine 1 (numbered 0 by convention)
    hal.rcout->write(0,900);
