...
// remember that the auxiliary outputs do not require the set_freq, as in general
// a servomotor operates at 50hz
// auxiliary channel 2 numbered as 9

    hal.rcout->enable_ch(9);

// main outputs at 490 hz
    hal.rcout->set_freq( 3, 490); //0xFF  0x0F->b'00000011'
    ...
    // starting the two respective BLDCs and the servo
    hal.rcout->write(0,900);
    hal.rcout->write(1,900);
    hal.rcout->write(9,900);
...
void loop(void)
{
    ...
    hal.rcout->write(1,1700);
    hal.rcout->write(9,1000);

    hal.scheduler->delay(1000);

    hal.rcout->write(0,1900);
    hal.rcout->write(1,1860);
    hal.rcout->write(9,1200);
