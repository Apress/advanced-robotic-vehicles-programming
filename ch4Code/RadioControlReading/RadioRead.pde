...
void loop(void)
{
// step 1 read all the channels
    for (uint8_t i = 0; i <6; i++)
	{radio[i] = hal.rcin->read(i);}

// step 2 assign the readings to variables and adapt them according to personal scales
// mode 2 of remote control are usually associated with multicopters
...
// Displaying data every 20 milliseconds by using pause or delay
    hal.scheduler->delay(20);
    hal.console->printf("%d\t %d\t %d\t\n",radio_roll,radio_pitch,radio_yaw);
