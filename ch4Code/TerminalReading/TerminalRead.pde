...
void loop(void)
{
    toread();    // toread function is called
}

static void toread(){
    readd= hal.console->read(); // read command
    hal.console->printf("hola %c\n",readd);
    hal.scheduler->delay(300); // without this delay you won't see nothing
}
